...
| [4-architecture.md](./4-architecture.md) | Document the `2-full_stack` architecture from its real files: services, the `2-full_stack_default` network and DNS by service name, volumes, the request path (hit, miss, bypass), the start order, plus ASCII and Mermaid diagrams. |
